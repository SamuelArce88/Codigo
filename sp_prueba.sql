...
​
    ...
    PSO_DESC_MSG := '';
​
    -- PASO 1: Captura atómica de registros
...
​
    -- FIX: distingue "sin registros" (retorna 0/CODIGO_EXITO → Java duerme)
    --      de "éxito al procesar" (retorna 3 → Java continúa)
    IF l_registros.COUNT = 0 THEN
        COMMIT;
        RETURN; -- PNO_CDG_MSG queda en 0 = señal para dormir
    END IF;
​
